...
namespace BookRental.Controllers
{
	...
	public class ManageController : Controller
	{
		...
		public async Task<ActionResult> Index(ManageMessageId? message)
		{
			...
			{
				var userInDb = _context.Users.First(u => u.Id == userId);
				var model = new IndexViewModel
				{
					...
					MembershipTypeId=userInDb.MembershipId,
		...
		public async Task<ActionResult> Edit()
		{
			...
			{
				var userInDb = _context.Users.First(u => u.Id.Equals(userId));
				var model = new IndexViewModel
				{
					HasPassword = HasPassword(),
					PhoneNumber = await UserManager.GetPhoneNumberAsync(userId),
		...
		public ActionResult Edit(IndexViewModel model)
		{
			using (var db = ApplicationDbContext.Create())
			{
				if (ModelState.IsValid)
				{
					...
					userInDb.MembershipId = model.MembershipTypeId;
